...
const Skills = () => {
  return (
    <div className=" w-[100%] bg-[#110f1a] p-10 py-20 text-white flex justify-center items-center flex-col">
      <h2 className=" text-[50px]">Skills</h2>
      <div className=" w-[70vw] flex flex-wrap gap-5 p-20 text-xl justify-center select-none">
        {mySkills.map((item) => {
          return (
